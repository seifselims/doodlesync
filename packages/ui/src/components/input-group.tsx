...
import { Textarea } from "@doodlesync/ui/components/textarea";
...
function InputGroupAddon({
	...
	return (
		// biome-ignore lint/a11y/noStaticElementInteractions: This wrapper extends the control’s pointer focus area without adding an independent action.
		// biome-ignore lint/a11y/useKeyWithClickEvents: Clicking the addon only focuses the control, which is already reachable with Tab.
		<div
